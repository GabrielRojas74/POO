...
public class Gato {
  ...
  public void dormir(int horas){
    if (this.energia<=100){
    System.out.println("el gato tiene la energia completa (nivel de energia"+energia+"%)");
  ...
  public void jugar(){
    ...
    if (this.energia<=0  || this.nivelcomida<=0){
      ...
      this.energia-=5;
      this.nivelcomida-=5;
      System.out.print("\n"+"A el gato le encata jugar"+"\n"+"su nuevo nivel de energia es del "+this.energia+"%"+"\n"+"y su  nuevo nivel de comida es del " +this.nivelcomida+"%");
